...
import '../Spotify/Screens/FavoritePlaylistScreen.dart';
import './dialogs.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                buildFavoritePlaylistButton(), // Add this line to include the playlist button
              ],
            ),
          ),
        ),
  ...
  // Button for selecting favorite playlist
  Widget buildFavoritePlaylistButton() {
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => FavoritePlaylistScreen()),
        );
      },
      child: Row(
        ...
        children: [
          const Icon(Icons.library_music, color: Colors.black), // Replace with Spotify icon
          const SizedBox(width: 8), // Adjust spacing as needed
          const Text(
            'Choose Favorite Playlists',
