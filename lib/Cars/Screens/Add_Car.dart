...
import '../../Trips/Screens/CreateTripScreen.dart';
...
class _AddCarScreenState extends State<AddCarScreen> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      String carID = carRef.id; // Get the generated car ID

      await carRef.update({
        'carID': carID, // Update the car document with the carID
      });
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => CreateTripScreen(carID: carID)),
      );
    }
  }
